...
class SettingViewController: UIViewController {
    ...
    @IBAction func tapTextColorButton(_ sender: UIButton) {
        ...
        case yellowButton:
            ...
            self.purpleButton.alpha = 0.2
            self.greenButton.alpha = 0.2
        case purpleButton:
            self.yellowButton.alpha = 0.2
        ...
        default:
            print("tapTextColorButton - default")
        }
        */
    }
    ...
    @IBAction func tapBackgroundColorButton(_ sender: UIButton) {
        ...
        default:
            print("tapBackgroundColorButton - default")
        }
        /*
        switch sender {
        case blackButton:
