...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func addTimeLabel() {
        ...
        let centerY: NSLayoutConstraint
        centerY = timeLabel.topAnchor.constraint(equalTo: self.playPauseButton.bottomAnchor, constant: 1)
    ...
    func addProgressSlider() {
        ...
        let centerY: NSLayoutConstraint
        centerY = slider.topAnchor.constraint(equalTo: self.timeLabel.bottomAnchor, constant: 8)
