...
class CenterNetwork {
    ...
    func getCenterList() -> AnyPublisher<[Center], URLError> {
        ...
        request.setValue("Infuser +1DsJb/pbAhuAojhLKBdY9WosqGreb8DbRr8ipvAAWchWRtgg0pIosTQS2ZqrCt8DiXHsDkB9j/R2UIrJeDKAQ==", forHTTPHeaderField: "Authorization")
